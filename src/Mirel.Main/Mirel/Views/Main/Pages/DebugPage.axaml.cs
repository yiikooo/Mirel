...
public partial class DebugPage : PageModelBase, IMirelTabPage, IMirelNavPage, IMirelTabContextMenuProvider
{
    ...
    // 实现 IMirelTabContextMenuProvider 接口
    public List<TabContextMenuEntry>? GetCustomContextMenuItems()
    {
        // 使用简单列表方式添加自定义菜单项
        return new List<TabContextMenuEntry>
        {
            new TabContextMenuEntry
            {
                Header = "🐛 调试专用功能",
                Icon = Geometry.Parse("M256 0c53 0 96 43 96 96l0 3.6c0 15.7-12.7 28.4-28.4 28.4l-135.1 0c-15.7 0-28.4-12.7-28.4-28.4l0-3.6c0-53 43-96 96-96z"),
                Command = new RelayCommand(() =>
                {
                    Overlay.Notice("这是调试页面的自定义菜单项！", NotificationType.Information);
                }),
                Priority = 10
            },
            new TabContextMenuEntry
            {
                Header = "📊 查看调试信息",
                Icon = Geometry.Parse("M160 80c0-26.5 21.5-48 48-48l32 0c26.5 0 48 21.5 48 48l0 352c0 26.5-21.5 48-48 48l-32 0c-26.5 0-48-21.5-48-48l0-352zM0 272c0-26.5 21.5-48 48-48l32 0c26.5 0 48 21.5 48 48l0 160c0 26.5-21.5 48-48 48l-32 0c-26.5 0-48-21.5-48-48L0 272zM368 96l32 0c26.5 0 48 21.5 48 48l0 288c0 26.5-21.5 48-48 48l-32 0c-26.5 0-48-21.5-48-48l0-288c0-26.5 21.5-48 48-48z"),
                Command = new RelayCommand(() =>
                {
