...
public partial class NewTabPage : PageModelBase, IMirelNavPage
{
    ...
    public NewTabPage()
    {
        ...
        {
            if (ListBox.SelectedItem is AggregateSearchEntry entry) AggregateSearchService.HandleSelection(entry, this);
